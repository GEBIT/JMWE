...
public class WorkflowAddFieldValueToParentFunction extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory {
	private Logger log = Logger.getLogger(WorkflowAddFieldValueToParentFunction.class);
    ...
    public WorkflowAddFieldValueToParentFunction(WorkflowUtils workflowUtils, FieldCollectionsUtils fieldCollectionsUtils) {
